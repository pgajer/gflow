...
#'   indices. Phase 1 supports observed anchors only.
#' @param anchor.coordinates Reserved for later off-observation anchors; this
#'   implementation requires \code{NULL}.
#' @param degree Polynomial degree. Phase 1 supports \code{0L}, \code{1L}, and
#'   \code{2L}.
...
#' @param exclude.self Logical. Phase 1 requires \code{TRUE}.
...
#' @param drop.rank.deficient Logical. Phase 1 requires \code{TRUE}.
