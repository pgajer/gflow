...
#' @param min.persistence.quantile Numeric in the closed interval `[0, 1]`;
#'   quantile threshold over tip persistence.
#' @param min.length.quantile Numeric in the closed interval `[0, 1]`;
#'   quantile threshold over tip length.
