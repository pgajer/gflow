...
SEXP S_graph_spectral_smoother(SEXP Rgraph,
    ...
    //
    SEXP Rresult = PROTECT(Rf_allocVector(VECSXP, 9));
    {
    ...
    // evalues
    {
        ...
        SEXP Revalues = PROTECT(Rf_allocVector(REALSXP, evalues_length));
    ...
    // evectors
    {
        ...
        SEXP Revectors = PROTECT(Rf_allocMatrix(REALSXP, evectors_rows, evectors_cols));
    ...
    {
        SEXP Roptimal_num_eigenvectors = PROTECT(Rf_allocVector(INTSXP, 1));
    ...
    // y_smoothed
    {
        ...
        SEXP Ry_smoothed = PROTECT(Rf_allocVector(REALSXP, y_smoothed_length));
    ...
    // cv_errors matrix
    {
        ...
        SEXP Rcv_errors = PROTECT(Rf_allocMatrix(REALSXP, cv_errors_rows, cv_errors_cols));
    ...
    // mean_cv_errors
    {
        ...
        SEXP Rmean_cv_errors = PROTECT(Rf_allocVector(REALSXP, mean_cv_errors_length));
    ...
    // low_pass_ys matrix
    {
        ...
        SEXP Rlow_pass_ys = PROTECT(Rf_allocMatrix(REALSXP, low_pass_ys_rows, low_pass_ys_cols));
    ...
    // Rmin_num_eigenvectors
    {
        SEXP Rmin_num_eigenvectors = PROTECT(Rf_allocVector(REALSXP, 1));
        REAL(Rmin_num_eigenvectors)[0] = result->min_num_eigenvectors;
        SET_VECTOR_ELT(Rresult, 7, Rmin_num_eigenvectors);
        UNPROTECT(1);
    }

    // Rmax_num_eigenvectors
    {
        SEXP Rmax_num_eigenvectors = PROTECT(Rf_allocVector(REALSXP, 1));
