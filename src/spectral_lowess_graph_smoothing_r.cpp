...
SEXP S_spectral_lowess_graph_smoothing(
    ...
    SEXP s_result = PROTECT(Rf_allocVector(VECSXP, 7)); nprot++;  // Increased from 5 to 7 for the new fields
    ...
    // Set names
    SEXP s_result_names = PROTECT(Rf_allocVector(STRSXP, 7)); nprot++;  // Increased from 5 to 7
