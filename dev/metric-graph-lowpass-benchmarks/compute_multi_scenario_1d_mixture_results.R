...
results <- run_multi_scenario_benchmark(repo.dir = repo.dir, progress = TRUE)

csv.file <- file.path(out.dir, "multi_scenario_1d_mixture_results.csv")
rds.file <- file.path(out.dir, "multi_scenario_1d_mixture_results.rds")
